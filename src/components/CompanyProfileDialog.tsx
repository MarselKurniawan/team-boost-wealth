...
const CompanyProfileDialog = ({ open, onOpenChange }: CompanyProfileDialogProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[380px] p-0 overflow-hidden rounded-[24px] border-slate-200 bg-[#f0fbf4] max-h-[90vh] overflow-y-auto">
        {/* Hero Header */}
        <div className="bg-gradient-to-br from-[#065f46] to-[#10b981] p-6 text-white">
          ...
          <p className="text-[10px] text-emerald-100 mt-1 uppercase tracking-widest font-medium">
        ...
        <div className="p-5 space-y-6">
          {/* About */}
          <section>
            <h2 className="text-[#065f46] text-[11px] font-bold uppercase tracking-wider mb-2">Tentang Kami</h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white p-3 rounded-xl border border-emerald-50">
              ...
              <h3 className="text-[#065f46] text-[10px] font-bold mb-1">Visi</h3>
            ...
            <div className="bg-white p-3 rounded-xl border border-emerald-50">
              ...
              <h3 className="text-[#065f46] text-[10px] font-bold mb-1">Misi</h3>
              <p className="text-slate-500 text-[9px] leading-snug">
          ...
          <div className="bg-white rounded-xl border border-emerald-50 p-3">
            <div className="flex items-center justify-between">
              <div className="flex-1 text-center">
                <Globe2 className="w-3.5 h-3.5 mx-auto text-emerald-600 mb-1" />
                <p className="text-[12px] font-bold text-[#065f46]">21+</p>
                <p className="text-[8px] text-slate-400 uppercase tracking-wide">Negara</p>
              </div>
              <div className="w-px h-8 bg-emerald-100" />
              <div className="flex-1 text-center">
                <TrendingUp className="w-3.5 h-3.5 mx-auto text-emerald-600 mb-1" />
                <p className="text-[12px] font-bold text-[#065f46]">75%</p>
                <p className="text-[8px] text-slate-400 uppercase tracking-wide">Growth '20–'24</p>
              </div>
              <div className="w-px h-8 bg-emerald-100" />
              <div className="flex-1 text-center">
                <Factory className="w-3.5 h-3.5 mx-auto text-emerald-600 mb-1" />
                <p className="text-[12px] font-bold text-[#065f46]">200+</p>
          ...
          {/* Contact Footer */}
          <div className="bg-[#065f46] rounded-xl p-4 text-white space-y-2.5">
            <p className="text-[9px] text-emerald-300 uppercase tracking-widest font-bold">Hubungi Kami</p>
