    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <header className="border-b border-border bg-card/40 backdrop-blur">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <img src={appLogo} alt="Terracycle" className="h-7 w-7" />
            <span className="font-semibold text-sm">Terracycle</span>
          </Link>
      ...
      <footer className="border-t border-border mt-8">
        <div className="max-w-3xl mx-auto px-4 py-5 text-[11px] text-muted-foreground flex flex-wrap gap-x-4 gap-y-2 justify-between">
          <div>© {new Date().getFullYear()} Terracycle. Hak cipta dilindungi.</div>
