...
const Auth = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="animate-pulse text-[#3fae49] text-sm">Memuat...</div>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(180deg, #EAF9EC 0%, #DCF3DE 40%, #C7E9CA 100%)" }}
    >
      {/* Ambient sun */}
      ...
      <svg
        className="absolute inset-x-0 bottom-0 w-full h-[52vh] pointer-events-none"
      ...
      >
        {/* Furthest range */}
        <path
          d="M0,420 L180,260 L340,360 L520,220 L720,340 L900,240 L1120,360 L1300,260 L1440,340 L1440,600 L0,600 Z"
          fill="#B5E4B8"
          opacity="0.7"
        />
        {/* Mid range */}
        <path
          d="M0,470 L140,340 L320,430 L520,310 L720,420 L920,320 L1140,430 L1320,340 L1440,420 L1440,600 L0,600 Z"
          fill="#8AD48F"
          opacity="0.85"
        />
        {/* Near range */}
        <path
          d="M0,540 L120,420 L300,510 L500,400 L720,500 L940,410 L1160,510 L1340,420 L1440,500 L1440,600 L0,600 Z"
          fill="#5FAE68"
        />
        {/* Foreground water/plateau */}
        <path d="M0,570 L1440,570 L1440,600 L0,600 Z" fill="#3A8A45" />
      </svg>

      {/* Auth Card */}
      <div className="relative z-10 w-full max-w-[400px]">
        <div className="bg-white/85 backdrop-blur-xl border border-white shadow-[0_20px_60px_-15px_rgba(63,174,73,0.35)] rounded-3xl p-7">
          {/* Logo */}
          <div className="flex flex-col items-center mb-5">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#4FC15A] to-[#2E8A37] flex items-center justify-center p-2 shadow-lg shadow-emerald-500/30 mb-2.5">
              <img src={brandLogo} alt="Terracycle" className="w-full h-full object-contain" />
            </div>
            <span className="font-heading text-lg font-bold tracking-tight text-[#2E8A37]">TERRACYCLE</span>
            <span className="text-[10px] text-slate-500 mt-0.5 tracking-widest uppercase">
              Daur Ulang · Berkelanjutan
            </span>
          </div>
          ...
          {showForgotPassword ? (
            ...
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-5 bg-slate-100 h-10 rounded-full p-1">
                <TabsTrigger
                  value="login"
                  className="text-xs h-8 rounded-full data-[state=active]:bg-[#3fae49] data-[state=active]:text-white data-[state=active]:shadow-md"
                >
                  Masuk
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="login-password" className="text-[11px] text-slate-600">
                      Password
                    </Label>
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className="text-[11px] text-[#3fae49] hover:underline"
                    >
                      Lupa Password?
                    </button>
                  </div>
