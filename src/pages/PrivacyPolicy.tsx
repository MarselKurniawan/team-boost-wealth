...
const PrivacyPolicy = () => (
  <LegalLayout title="Kebijakan Privasi">
    <p>
      Kebijakan Privasi ini menjelaskan bagaimana Apptronik mengumpulkan, menggunakan, dan
    ...
    <p>
      ...
      hash dan tidak dapat dibaca oleh siapapun, termasuk tim internal Apptronik.
    </p>
    ...
    <p>
      Apptronik dapat memperbarui kebijakan ini sewaktu-waktu. Perubahan signifikan akan
      diinformasikan melalui notifikasi di aplikasi.
    </p>

    <h2>8. Kontak</h2>
    <p>
      Pertanyaan terkait privasi dapat dikirim ke <strong>support@apptronik.id</strong> atau
