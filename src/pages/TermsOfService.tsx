...
const TermsOfService = () => (
  <LegalLayout title="Syarat & Ketentuan Layanan">
    <p>
      Dengan mendaftar dan menggunakan layanan Apptronik, Anda menyatakan telah membaca,
    ...
    <ul>
      ...
      <li>Apptronik tidak bertanggung jawab atas kerugian akibat akun yang diretas karena kelalaian pengguna.</li>
      <li>Dilarang membagikan kode OTP kepada siapapun, termasuk staf Apptronik.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Menyebarkan informasi palsu mengatasnamakan Apptronik.</li>
    ...
    <p>
      Apptronik berhak menutup akun yang melanggar syarat ini tanpa pemberitahuan sebelumnya.
